...
![](/aitool/picture/sd-webui/other/019.png)

2. 直接下载代码

解压后将文件夹考贝到stable-diffusion-webui/extensions/下面，然后重启stable diffusion

![](/aitool/picture/sd-webui/other/020.png)

安装成功后会在sd界面下生成如下界面

![](/aitool/picture/sd-webui/other/021.png)

## 2. 下载模型

下载模型 https://hf-mirror.com/datasets/Gourieff/ReActor/tree/main/models

![](/aitool/picture/sd-webui/other/022.png)
...
![](/aitool/picture/sd-webui/other/023.png)
...
![](/aitool/picture/sd-webui/other/024.png)

2. 将ReActor前面打勾，启动ReActor，将导入一个人脸，如下图：

![](/aitool/picture/sd-webui/other/025.png)


3. 将重绘强度/Denoising strength调成`零`如下图

![](/aitool/picture/sd-webui/other/026.png)

4. 点击`生成/Generate`则换脸结果如下图

![](/aitool/picture/sd-webui/other/027.png)
...
![](/aitool/picture/sd-webui/other/028.png)

例如，如果将源图第二个人的人脸换到目标图的第三个人的人脸，那么第一个框填“1”，第二个框填“2”。

![](/aitool/picture/sd-webui/other/029.png)


2. 图片存放处理

    ![](/aitool/picture/sd-webui/other/030.png)
...
![](/aitool/picture/sd-webui/other/031.png)

选择高清化算法。

4. 设置

![](/aitool/picture/sd-webui/other/032.png)