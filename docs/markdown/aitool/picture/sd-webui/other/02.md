...
![](/aitool/picture/sd-webui/other/007.png)
...
![](/aitool/picture/sd-webui/other/008.png)
...
![](/aitool/picture/sd-webui/other/009.png)

![](/aitool/picture/sd-webui/other/010.png)
...
![](/aitool/picture/sd-webui/other/014.png)

如下图所示，可以看到人物变成了白色的蒙版，我们把这个蒙版图片先保存到本机，后面马上要用。

![](/aitool/picture/sd-webui/other/015.png)

2. 更换背景

在`图生图`中打开`局部绘制(上传蒙版)`。这里需要上传两张照片，一张原图，一张人物的蒙版图。

![](/aitool/picture/sd-webui/other/016.png)
...
![](/aitool/picture/sd-webui/other/017.png)
...
![](/aitool/picture/sd-webui/other/018.png)