...
4. 配置 systemd 服务
    ...
    [Service]
    Type=simple
    ExecStart=/usr/shadowsocks-server/ssserver -c /usr/shadowsocks-server/config.json
...
1. 下载文件
    ...
    ![](/network/external/shadowsocks/014.png)
...
4. 保存手动代理
    ...
    ![](/network/external/shadowsocks/015.png)

5. google连接

    ![](/network/external/shadowsocks/016.png)